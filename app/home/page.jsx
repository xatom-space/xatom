    ...
    <main className="bg-white text-black">
      ...
      <section id="about" className="section-shell py-20 md:py-28">
        ...
        <div className="mt-8 max-w-4xl">
          ...
          >
            <p
              className={`${aboutExpanded ? '' : 'overflow-hidden'} about-copy`}
              style={
                aboutExpanded
                  ? undefined
                  : {
            ...
            {!aboutExpanded ? (
              <div className="relative mt-4">
                <p
                  className="about-copy overflow-hidden text-black/35 blur-[0.6px]"
                  style={{
                    display: '-webkit-box',
                    WebkitBoxOrient: 'vertical',
                    WebkitLineClamp: 2,
              ...
              <div className="mt-8 space-y-6">
                <p className="about-copy whitespace-pre-line">{aboutKo}</p>
              </div>
            )}
          </div>
        </div>
