...
const imageItems = [
  ...
  { desktopSrc: '/p9.jpg?v=20260527', mobileSrc: '/p9-mobile.jpg?v=20260527', alt: 'verume detail 3' },
  { desktopSrc: '/p10.jpg?v=20260527', mobileSrc: '/p10-mobile.jpg?v=20260527', alt: 'verume detail 4' },
  { desktopSrc: '/p11.jpg?v=20260527', mobileSrc: '/p11-mobile.jpg?v=20260527', alt: 'verume detail 5' },
  { desktopSrc: '/p12.jpg?v=20260527', mobileSrc: '/p12-mobile.jpg?v=20260527', alt: 'verume detail 6' },
  { desktopSrc: '/p13.jpg?v=20260527', mobileSrc: '/p13-mobile.jpg?v=20260527', alt: 'verume detail 7' },
] as const;
    ...
    <main className="overflow-x-clip bg-white text-black">
      ...
      <section className="section-shell py-12 md:py-24">
        ...
        <div className="relative left-1/2 mt-20 w-screen -translate-x-1/2 space-y-6 md:static md:mt-32 md:w-full md:translate-x-0 md:space-y-8">
          ...
          <ManagedVideoBlock src="/m1.mp4" poster="/p8-mobile.jpg?v=20260527" />
