...
export default function IntroPage() {
  ...
  return (
    <main className="relative h-screen w-screen overflow-hidden bg-white">
      ...
      >
        {/* 캐시 방지용 버전 파라미터 */}
        <source src="/intro-v2.mp4?v=20260515-4" type="video/mp4" />
      </video>
      ...
      <div className="relative z-20 flex h-full w-full flex-col items-center justify-center">
        ...
        <Link href="/home" aria-label="Go to home">
          <img
            src="/xatom-v1.png"
            alt="xatom logo"
            className="h-[224px] w-auto max-w-[86vw] object-contain md:h-[320px]"
          />
        </Link>
        ...
        <p
          className={[
            'mt-2 text-black text-2xl tracking-wide md:mt-3',
