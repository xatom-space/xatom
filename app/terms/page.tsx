...
① “몰”이란 xatom (엑스아톰) 회사가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호․모사전송번호․전자우편주소, 사업자등록번호, 통신판매업 신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 xatom (엑스아톰) 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.
  ...
  return (
    <main className="bg-white text-black">
      ...
      <section className="section-shell py-12 md:py-24">
        <p className="text-[10px] uppercase tracking-[0.35em] text-black/60">Terms</p>
        <h1 className="mt-6 text-xl font-semibold tracking-[0.06em] md:text-2xl">TERMS OF USE</h1>
        <pre className="mt-10 whitespace-pre-wrap break-keep text-sm font-light leading-8 text-black/70">
          {terms}
        </pre>
      </section>
    </main>
